    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arrivals', to='app.place')),
                ('origin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departures', to='app.place')),
                ('depart_day', models.ManyToManyField(related_name='flights_of_the_day', to='app.week')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ...
                ('passengers', models.ManyToManyField(related_name='flight_tickets', to='app.passenger')),
