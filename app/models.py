...
class Passenger(models.Model):
    ...
    #passenger = models.ForeignKey(SimpleUser, on_delete=models.CASCADE, related_name="flights")
...
class Ticket(models.Model):
    user = models.ForeignKey(SimpleUser,on_delete=models.CASCADE,related_name="bookings", blank=True, null=True)
    ref_no = models.CharField(max_length=6)
    passengers = models.ManyToManyField(Passenger, related_name="flight_tickets",blank=True )
